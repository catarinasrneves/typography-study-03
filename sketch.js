...
inputimg.position(20,130);
  ...
  hSlider.position(20, 280);
    ...
    button1=createButton("type 01");
    button1.mousePressed(changeTypeserif)
    button1.position(20,360);
    
    button2=createButton("type 02");
    button2.mousePressed(changeTypesans)
    button2.position(78,360);
    
    button3=createButton("type 03");
...
function draw() {
  ...
  background(255);
   ...
   textSize(12); 
  text('size', sSlider.x * 2 + sSlider.width, 235);
